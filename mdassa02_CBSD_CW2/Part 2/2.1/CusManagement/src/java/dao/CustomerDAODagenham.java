...
/**
 * DAO Classes, CRUD Operations on Customer table of Dagenham database
 * @author Sachith
 */
public class CustomerDAODagenham implements CustomerDAOInt{

    Connection connection = null;
    PreparedStatement prestmnt = null;
    ResultSet resultSet = null;

    public CustomerDAODagenham() {
    }
