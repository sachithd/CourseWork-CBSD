...
/**
 * This class handles all the CRUD operations on Customer table on Stratford database
 * @author Sachith
 */
public class CustomerCRUDStratford {

    Connection connection = null;
    PreparedStatement prestmnt = null;
    ResultSet resultSet = null;

    public CustomerCRUDStratford() {
    }
